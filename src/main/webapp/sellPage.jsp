...
<html>
    ...
    <body>
        ...
        <div class="form-container">
            <div id="publication-edit-form" class="publicacion-form"><form action="login" method="post">
            ...
            <div id="publication-create-form"  class="publicacion-form"><form action="login" method="post">
